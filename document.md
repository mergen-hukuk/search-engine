...
🚀 Try Zilliz Cloud, the fully managed Milvus, for free—experience 10x faster performance! [Try Now>>](https://cloud.zilliz.com/signup?utm_source=partner&utm_medium=referral&utm_campaign=2024_12_23_top_banner_milvusio)

[![milvus-logo](/images/milvus_logo.svg)](/)![LFAI](/images/lf_logo.png)
...
* [Blog](/blog)
* [Community](/community)
[Star31.7K](https://github.com/milvus-io/milvus)[Get Started](/docs/quickstart.md)[![milvus-logo](/images/milvus_logo.svg)](/)![LFAI](/images/lf_logo.png)[Docs](/docs)
...
[Get Started](/docs/quickstart.md)Search[Home](/docs)[v2.5.x](/docs/integrate_with_spark.md)​
...
* Tools
  ...
  + Milvus CLI
  + Milvus Connectors
    - [Spark](/docs/integrate_with_spark.md)
  + [Milvus Sizing Tool](https://milvus.io/tools/sizing/)
  + [Powershell Milvus Client](https://github.com/rrg92/ps-milvus/blob/main/docs/integrate_powershell.md)
* Integrations
* Tutorials
* FAQs
* API Reference
...
| `milvus.collection.autoID` | `false` | If the collection does not exist, this option specifies whether to automatically generate IDs for the entities. For more information, see [create\_collection](https://milvus.io/docs/create_collection.md) |
...
1. Load the Spark runtime by adding a jar file to your Databricks Cluster.
   ...
   ![Install Databricks Library](/docs/v2.5.x/assets/install-databricks-library.png)
...
* [Spark-Milvus Connector User Guide](#Spark-Milvus-Connector-User-Guide)
* [Quick start](#Quick-start)
* [Features & concepts](#Features--concepts)
* [Milvus data format](#Milvus-data-format)
...
[Get Started](https://cloud.zilliz.com/signup?utm_source=partner&utm_medium=referral&utm_campaign=2024-10-17_display_manged-milvus-docs_milvusio)

* [Edit this page](https://github.com/milvus-io/milvus-docs/edit/v2.5.x/site/en/integrations/integrate_with_spark.md)
...
![Milvus logo](/images/milvus_logo.svg)Made with Love ![Blue Heart Emoji](/images/blue-heart.png) by the Devs from [Zilliz](https://zilliz.com/)
### Get Milvus Updates
...
* [Docs](/docs)
* [Blog](/blog)
* [Managed Milvus](https://cloud.zilliz.com/signup)
### Tutorials
